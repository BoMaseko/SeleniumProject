...
public class TestBase {
	...
	public static void initialization() {
		...
		driver.manage().timeouts().implicitlyWait(TestBaseUtil.IMPLICIT_WAIT, TimeUnit.MILLISECONDS);
		driver.manage().timeouts().pageLoadTimeout(TestBaseUtil.PAGE_LOAD_TIMEOUT, TimeUnit.MILLISECONDS);
